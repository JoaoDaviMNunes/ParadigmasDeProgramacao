...
#O resultado deve ser True ou False. Você não deve usar o operador in. Defina uma função auxiliar para ajudar neste exercício.
def charFound(c, lista):
    def verifica(x): return x == c
    return len(list(filter(verifica, lista))) > 0
